...
class AdminController extends Controller
{
    ...
    {
        $value = DB::select("SELECT distinct u.user_id,u.isActive,p.patient_id,p.nom,p.prenom,p.sexe,p.telePerso,p.dateNaiss FROM `consultations` c inner join patients p on p.patient_id = c.patient_id inner join users u on u.user_id = p.user_id  order by c.date"); 
        return $value;
    }
